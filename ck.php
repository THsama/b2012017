...
setcookie($cookie_name, $cookie_value, time() + (86400  24), );  86400 = 243600 = 1 day
...
pstrongNotestrong You might have to reload the page to see the value of the cookie.p
